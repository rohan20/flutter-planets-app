...
class PlanetDao {
  static final List<Planet> planets = [
    ...
    const Planet(
      ...
      pictureUrl: "https://solarstory.net/img/articles/big/artist-concept-of-sunrise-on-neptune.jpg",
    ),
    const Planet(
      id: "3",
      name: "Moon",
      ...
      pictureUrl: "https://i0.wp.com/tecake.in/wp-content/uploads/2017/11/Super-moon.jpg?resize=990%2C555&ssl=1",
    ),
    const Planet(
      id: "4",
      name: "Earth",
      ...
      pictureUrl: "https://gweb-earth.storage.googleapis.com/assets/hero@2x.jpg",
    ),
    const Planet(
      id: "5",
      name: "Mercury",
      ...
      pictureUrl: "https://www.universetoday.com/wp-content/uploads/2010/06/Planet-Mercury.jpg",
    ),
  ];
}
